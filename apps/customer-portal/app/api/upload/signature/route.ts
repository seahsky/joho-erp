/**
 * Proxy Upload API Route for Signatures
 *
 ...
 *
 * Security:
 * - Public endpoint (signatures uploaded before account creation)
...
export async function POST(request: NextRequest): Promise<NextResponse<UploadResponse>> {
  try {
    ...
    // 7. Validate file size (500KB max)
    ...
    // 10. Upload to R2 (using signature path pattern)
