...
export function IdentityDocumentUpload({
  ...
  const t = useTranslations('onboarding.directors.idDocument');
  ...
  const handleDocumentTypeChange = (newType: IdDocumentType) => {
    // When changing type, clear any existing uploads
    onChange({
...
IdentityDocumentUpload.displayName = 'IdentityDocumentUpload';
