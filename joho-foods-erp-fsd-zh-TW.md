...
本文件從業務角度描述 Joho Foods ERP 系統的運作方式。說明使用者可以執行的操作、流程如何進行，以及管理系統行為的規則。本文件不涵蓋技術實作細節。

### **1.2 範圍**

系統由兩個網路入口網站組成：
- **客戶入口網站** - 供企業客戶瀏覽產品和下訂單
- **管理入口網站** - 供 Joho Foods 員工管理營運
...
Joho Foods ERP 系統管理澳洲 B2B 肉品配銷業務的整個訂單到配送工作流程：
